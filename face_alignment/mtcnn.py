...
class MTCNN():
    def __init__(self, device: str = 'cuda:0', crop_size: Tuple[int, int] = (112, 112)):
        ...
        self.min_face_size = 12  # Reduce from 20 to 12
        self.thresholds = [0.2, 0.3, 0.4]  # Lower from [0.6, 0.7, 0.9]
        self.nms_thresholds = [0.4, 0.4, 0.4]  # Lower from [0.7, 0.7, 0.7]
        self.factor = 0.509  # Slightly adjust scale factor for more scales
